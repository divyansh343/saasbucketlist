...
const terms = () => {
  return (
    <div className='lg:mx-44'>
      <section class="px-4 py-24 mx-auto max-w-7xl font-two">
        <div class="px-4 py-24 mb-20 text-left bg-gray-50 md:text-center">
          ...
          <p class="text-base text-gray-500 md:text-lg">Last updated: 20th Dec 2022</p>
        </div>
        <div class="mx-auto prose">
          <h2 className='my-6 text-xl font-semibold' id="1legalnotices">1. Legal Notices</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="2permittedandprohibiteduses">2. Permitted and Prohibited Uses</h2>
          ...
          <p>
            You may not upload or transmit any material that infringes or misappropriates any persons copyright, patent, trademark, or trade secret, or disclose via the the Website any information the
            disclosure of which would constitute a violation of any confidentiality obligations you may have.
          </p>

          <p>
            You may not upload any viruses, worms, Trojan horses, or other forms of harmful computer code, nor subject the Websites network or servers to unreasonable traffic loads, or otherwise engage in
          ...
          <h2 className='my-6 text-xl font-semibold' id="3usersubmissions">3. User Submissions</h2>
          ...
          <p>
            If you work for a company or at a University, it is likely that you are not the copyright holder of anything you make, even in your free time. Before making contributions to this site, get written
            permission from your employer.
          </p>

          <h2 className='my-6 text-xl font-semibold' id="4userdiscussionlistsandforums">4. User Discussion Lists and Forums</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="5useofpersonallyidentifiableinformation">5. Use of Personally Identifiable Information</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="6indemnification">6. Indemnification</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="7termination">7. Termination</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="8warrantydisclaimer">8. WARRANTY DISCLAIMER</h2>
          ...
          <p className='lowercase'>
            THE OPERATORSS TOTAL CUMULATIVE LIABILITY FOR ANY AND ALL CLAIMS IN CONNECTION WITH THE WEBSITE WILL NOT EXCEED FIVE U.S. DOLLARS ($5.00). USER AGREES AND ACKNOWLEDGES THAT THE FOREGOING
          ...
          <h2 className='my-6 text-xl font-semibold' id="9general">9. General</h2>
          ...
          <p>
            ...
            writing at that partys principal place of business, attention of that partys principal legal officer, or at such other address or by such other method as the party shall specify in writing.
            ...
            Any action or proceeding arising out of or related to this Agreement or Users use of the Website must be brought in the courts of Belgium, and you consent to the exclusive personal jurisdiction
          ...
          <h2 className='my-6 text-xl font-semibold' id="10linkstoothermaterials">10. Links to Other Materials</h2>
          ...
          <h2 className='my-6 text-xl font-semibold' id="11notificationofpossiblecopyrightinfringement">11. Notification Of Possible Copyright Infringement</h2>
