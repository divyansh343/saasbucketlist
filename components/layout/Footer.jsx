...
const Footer = () => {
  return (
    <section class="py-10 bg-white sm:pt-16 lg:pt-24 font-two">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
          <div class="col-span-2 md:col-span-4 xl:pr-8">
            <Image height={50} width={50} class="w-auto h-9" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg" alt="" />
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <p class="text-sm text-gray-600">© Copyright 2023, All Rights Reserved by -----------</p>
